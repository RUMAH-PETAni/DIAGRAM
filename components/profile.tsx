...
export function Profile({
  ...
  useEffect(() => {
    ...
    const localAvatars = [
      'male.webp', 'female.webp', 'male1.webp', 'female1.webp','male2.webp', 'female2.webp',
      'male3.webp', 'female3.webp','male4.webp', 'female4.webp'
    ];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Set editing mode back to false after successful save
      setIsEditing(false);
    } catch (error) {
