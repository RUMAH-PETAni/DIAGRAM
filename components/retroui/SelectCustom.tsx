...
const SelectTrigger = ({
  ...
  return (
    <SelectPrimitive.Trigger
      className={cn(
        "flex h-10 min-w-40 items-center shadow-md focus:shadow-xs justify-between border-2 border-input bg-transparent px-4 py-2 placeholder:text-muted-foreground outline-none focus:outline-none focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
        className,
      )}
      {...props}
    >
...
export { SelectObj as Select, SelectContent, SelectItem, SelectTrigger, SelectValue };
