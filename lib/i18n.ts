...
export const translations = {
  en: {
    ...
    agroforestryDesc: 'Connect farmers, buyers, and service providers in a sustainable agricultural ecosystem. Find trusted partners and build a fair and transparent value chain.',
    ...
    usersDashboardDesc: 'Manage and monitor user activities, permissions, and profile information in a comprehensive dashboard.',
    landMapping: 'Mapping & Survey',
    landMappingDesc: 'Create detailed maps of agricultural land with advanced surveying tools and GPS integration.',
    farmMonitoring: 'Farm Monitoring',
    farmMonitoringDesc: 'Track and analyze farm conditions, growth patterns, and health status using satellite imagery.',
    soilClimateData: 'Soil & Climate Data',
    soilClimateDataDesc: 'Access real-time data on soil quality, moisture levels, and climate conditions for optimal farming decisions.',
    logActivity: 'Activities Record',
    logActivityDesc: 'Keep detailed records of farming activities, treatments, and operations to improve farm management.',
    carbonFootprint: 'Carbon Footprint',
    carbonFootprintDesc: 'Calculate and monitor your farm\'s carbon footprint to support sustainable agriculture practices.',
    ...
    communityHubDesc: 'Connect with fellow farmers, experts, and industry professionals to share knowledge and experiences.',
  ...
  id: {
    ...
    usersDashboardDesc: 'Kelola dan pantau aktivitas pengguna, izin, dan informasi profil dalam dashboard komprehensif.',
    landMapping: 'Survey & Pemetaan',
    landMappingDesc: 'Buat peta terperinci lahan pertanian dengan alat survei canggih dan integrasi GPS.',
    farmMonitoring: 'Pemantauan Pertanian',
    farmMonitoringDesc: 'Lacak dan analisis kondisi pertanian, pola pertumbuhan, dan status kesehatan dengan citra satelit.',
    soilClimateData: 'Data Tanah & Klimatologi',
    soilClimateDataDesc: 'Akses data waktu nyata tentang kualitas tanah, kadar kelembapan, dan kondisi iklim.',
    logActivity: 'Catatan Aktifitas',
    logActivityDesc: 'Simpan catatan terperinci tentang aktivitas pertanian, perawatan, dan operasi untuk manajemen pertanian yang lebih baik.',
    carbonFootprint: 'Lacak Jejak Karbon',
    carbonFootprintDesc: 'Hitung dan pantau jejak karbon pertanian Anda untuk mendukung praktik pertanian berkelanjutan.',
    aiRecommendation: 'Wawasan & Rekomendasi',
    ...
    communityHubDesc: 'Terhubung dengan petani, ahli, dan profesional industri lainnya untuk berbagi pengetahuan dan pengalaman.',
    ...
    sustainableAgricultureDesc: 'Platform kami mempromosikan praktik pertanian berkelanjutan untuk memastikan pelestarian lingkungan dan produktivitas pertanian jangka panjang.',
    letsJoin: 'Mari Bergabung Bersama Ekosistem Kami',
